...
rep = """ SET FOREIGN_KEY_CHECKS=0; SET @TRIGGER_CHECKS = FALSE; TRUNCATE TABLE `Category`; """
sql = """ SELECT * FROM certificate_category; """
...
try:
	...
	for ROW in resultset:
		#print(row)
		sql = str.format("INSERT INTO `Category` VALUES({0}, {1}, {2}, {3}, {4});",
					  getValue(ROW[1]), getValue(ROW[0]), 'NULL', getValue(ROW[4]), getValue(ROW[4]))
